<?php
	...
	*/
	...
	if(!ini_get('date.timezone')) {
		...
		if(PHP_OS == 'WIN32' || PHP_OS == 'WINNT' || PHP_OS == 'Windows')
			echo '>> Re-read the Install PHP guide @ http://botdom.com/documentation/Install_PHP_on_Windows#Part_2 (Step 7-9)',chr(10),'>> ';
		if(PHP_OS == 'Linux')
			echo '>> Re-read the Install PHP guide @ http://botdom.com/documentation/Install_PHP_on_Linux#PHP_configure_setup (Step 2-4)',chr(10),'>> ';
		if(PHP_OS == 'Darwin')
			echo '>> Re-read the Install PHP guide @ http://botdom.com/documentation/Install_PHP_on_Mac_OS_X#PHP_configure_setup (Step 2-4)',chr(10),'>> ';
		for($i = 0;$i < 3; ++$i) {
			sleep(1);
			echo '.';
		}
